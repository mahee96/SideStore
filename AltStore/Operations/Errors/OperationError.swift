...
extension MinimuxerError: LocalizedError {
    public var failureReason: String? {
        ...
        case .PairingFile:
            return NSLocalizedString("Invalid pairing file. Your pairing file either didn't have a UDID, or it wasn't a valid plist. Please use idevice pair to regenerate it", comment: "")
