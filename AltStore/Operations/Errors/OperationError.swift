...
struct OperationError: ALTLocalizedError {
    ...
    var errorFailureReason: String {
        ...
        case .unknownUDID: return NSLocalizedString("SideStore could not determine this device's UDID. Please recreate your pairing using idevice_pair.", comment: "")
...
extension MinimuxerError: LocalizedError {
    public var failureReason: String? {
        ...
        case .PairingFile:
            return NSLocalizedString("Invalid pairing file. Your pairing file either didn't have a UDID, or it wasn't a valid plist. Please use idevice_pair to recreate it.", comment: "")
